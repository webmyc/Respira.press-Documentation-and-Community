...
As of 8.7, Respira exposes **214 MCP tools** on any WordPress site and **319** with the WooCommerce add-on installed (105 of those are `woocommerce_*` tools), alongside **277 WebMCP browser abilities** and **46 skills**. Those numbers were measured by booting the MCP server and calling `tools/list`. This reference documents the core categories and naming patterns.
