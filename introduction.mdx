...
Respira now supports two workflows: **Browser AI** (WebMCP built-in) and **Desktop AI** (MCP server). Both share the same safety workflow. As of 8.7 that is 214 MCP tools on any WordPress site, 319 with the WooCommerce add-on, plus 277 WebMCP abilities, depending on your add-ons and runtime.
...
- 214 MCP tools on any WordPress site, 319 with the WooCommerce add-on (105 `woocommerce_*` tools), covering ACF, the Site Editor, element-level editing, page building, stock images, and tool governance
