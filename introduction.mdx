...
Respira now supports two workflows: **Browser AI** (WebMCP built-in) and **Desktop AI** (MCP server). Both share the same safety workflow. As of 8.8 that is 220 MCP tools on any WordPress site, 325 with the WooCommerce add-on, plus 277 WebMCP abilities, depending on your add-ons and runtime.
